...
/*
 ...
 Monitor program for 6809 Microprocessor Kit 2017
 written by Wichit Sirichote, wichit.sirichote@gmail.com, July 2017
 Source code was compiled with cc09 c compiler

 cc09>cc09 file.c file.asm -z -c
 cc09>as9 file.asm
...
/* scan display and keyboard one cycle, return internal code if key pressed */
...
get_s_record()
{
   ...
   while(end==0)
   {
	 ...
	 while(getchar() != 'S')
      ...
      switch(getchar()) /* get record type */
      {
       case '0': end=0; break;
...
main()
{
   ...
   newline();
   puts("6809 MICRIPROCESSOR KIT 2017");
