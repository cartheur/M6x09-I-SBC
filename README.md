...
New development work with the Motorola 6809 and Hitachi 6309 8-bit CPU for novelty. Multicomputing is the trajectory. A companion repository of [code](https://github.com/cartheur/M6809-A/tree/main/sbc) will be integrated here over time.
